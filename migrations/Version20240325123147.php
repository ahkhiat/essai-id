 ...
 */
final class Version20240325123147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres CHANGE theme_livre theme_livre VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres CHANGE theme_livre theme_livre VARCHAR(255) DEFAULT NULL');
    }
}
